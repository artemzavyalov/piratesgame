...
<div id="container" >
    <button onclick="store.clear(); $.post('clear.php', function(){});" >clear</button><br>
    ...
    <div id="SHOW_SETTINGS" style="display: none;">
        ...
        <div class="screenSlider"></div><br>
    </div>

    <? if($gamesWaitingMeCount): ?>
    <? foreach($gamesWaitingMe as $game): ?>
        <a href="/?a=game&mapId=<?=$game['game_mapId']?>&gameId=<?=$game['game_id']?>"><?=$game['user_name']?> ждёт тебя</a><br>
        <? endforeach; ?>
    <? endif; ?>
